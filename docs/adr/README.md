...
| ADR-0015 | Person-centric live tracking baseline: EfficientDet-Lite0 + greedy-IoU tracker, temporal provenance (accepted, M6) |Nota: El índice registra los ADR 0001–0012; los documentos individuales disponibles comienzan en ADR-0013.
